...
For a **[[Mixed Components]]** $T_{ik}$, the covariant derivative with respect to $x^\ell$ is
...
## Pre-Lecture Notes from [[mth3008 lecture notes 17.pdf]]
