...
| 1 | One element absent |
| 2 | One element incorrect |
...
| 1 | Partial use of sources |
| 2 | One requirement missing |
| 3 | All requirements met: 1+ references, 1+ quoted opinions (for/against), all relevant |
