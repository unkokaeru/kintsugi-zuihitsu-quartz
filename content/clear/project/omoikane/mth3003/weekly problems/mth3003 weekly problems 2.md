...
2. Write $G = H\cup S$ with $S\cap H=\emptyset$, so $|G|=|H|+|S|$. Hence $|G|=|H| \Rightarrow |S|=0 \Rightarrow S=\emptyset \Rightarrow G=H$.
$(\Leftarrow)$ Obvious.
...
> $$
>
> So $|\langle g\rangle|\le n$, hence $|\langle g\rangle|=n=o(g)$. $\blacksquare$
...
> $$
>
> Every element of $\mathbb{Z}_n$ lies in $\langle[1]_n\rangle$, so $\mathbb{Z}_n\subseteq\langle[1]_n\rangle$. Since $\langle[1]_n\rangle\le\mathbb{Z}_n$, we have $\mathbb{Z}_n=\langle[1]_n\rangle$. $\blacksquare$
