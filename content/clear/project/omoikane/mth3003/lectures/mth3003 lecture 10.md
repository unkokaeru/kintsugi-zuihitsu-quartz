...
This lecture pushes further into **[[isomorphism]]**, treating them as the right notion of "sameness" for groups and then using that perspective to classify groups of prime order. We also see concrete examples and a full proof that any group of prime order is **[[cyclic group]]** and hence isomorphic to a familiar model.
...
> - $\theta$ is **[[bijection]]** (one-to-one and onto).
> 
...
- The **[[cyclic group]]** $C_{n} = \langle \rho \rangle$ where $\rho$ is the $n$-cycle $(1\\,\dots\,n)$, operation is composition.
...
5. Now $\lvert H \rvert = \lvert G \rvert$, so by basic subgroup properties we conclude $H = G$.
   Thus, $G$ is **[[cyclic group]]**, generated by $g$, and
