...
```
The seventh claim also functions as an enabler for assessment for learning (AfL). Without metacognitive awareness, formative assessment becomes merely another form of testing rather than a tool for self-regulation. Husbands and Pearce's eighth claim emphasises embedding AfL [1], yet students must develop capacity to reflect on their understanding for this to succeed. Mevarech and Kramarski's IMPROVE method demonstrates that metacognitive questioning - "What is the problem asking?" and "Does my solution make sense?" - improves both achievement and understanding [7]. Research confirms that extended wait time particularly benefits lower-attaining students [5], while Hattie's meta-analyses show questioning yields substantial effect sizes on achievement [6].
```

The seventh claim posed by Husbands and Pearce also naturally enables assessment for learning (AfL). Without metacognitive awareness, formative assessment just becomes another type of examination rather than a process of learning. The eight claim, which discusses assessment for learning, emphasises the need to embed AfL [1] within learning, 
