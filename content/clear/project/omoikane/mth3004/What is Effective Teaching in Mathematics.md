...
```
Effective questioning requires pedagogical content knowledge (PCK) - the intersection of subject expertise and understanding how students learn. Teachers must anticipate student thinking to pose productive questions that advance understanding. Ball, Thames, and Phelps identify "mathematical knowledge for teaching" as distinct from content knowledge alone [8]; this includes recognising common misconceptions and knowing which representations illuminate particular concepts. Swan's research demonstrates that deliberately surfacing misconceptions through questioning - asking students to evaluate incorrect solutions or compare conflicting methods - produces deeper understanding than simply presenting correct procedures [11]. PCK enables teachers to craft questions that expose and address these misconceptions constructively.
```

However, effective questioning relies heavily on pedagogical content knowledge (PCK) - the knowledge of a subject alongside the understanding of how students learn. 
