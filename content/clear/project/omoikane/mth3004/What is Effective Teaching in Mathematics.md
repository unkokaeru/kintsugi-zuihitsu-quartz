...
```
Critics might contend that subject knowledge or prior learning claims are more fundamental - without knowledge, how can thinking develop? This represents a false dichotomy; questioning simultaneously builds knowledge and develops thinking. However, effective questioning demands substantial teacher expertise - a legitimate implementation challenge. This does not diminish the claim's importance but rather emphasises that developing questioning skills should be prioritised in teacher education and professional development [8][9].
```

Critics might propose that subject knowledge or prior learning claims are more fundamental - without knowledge, how can thinking develop? This represents a false dichotomy: questioning simultaneously builds knowledge and develops thinking, rather than improving them discretely. However, effective questioning requires a substantial amount of teacher expertise, which often remains a challenge to build, yet 
