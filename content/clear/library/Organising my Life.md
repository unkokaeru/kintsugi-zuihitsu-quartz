...
- **08:00 - 09:00** Head to the bathroom…
	...
	- Floss, tongue scrape, and use mouthwash.
	- Apply hand cream.
- **09:00 - 10:00** Head back to bedroom…
	- Put on any laundry if needed.
	- 30 minutes of yoga, ending in savasana - focus on breathing, and allow minoxidil to absorb.
	- Get dressed, vacuum if needed.
	- Complete skincare: toner -> serum -> moisturiser -> eye cream -> SPF 50+, letting each layer absorb.
	- Take Omega-3 supplements.
- **10:00 - 11:00** Head to the lounge…
	- Have some breakfast; anything works.
	- Journal a bit, scheduling out the day and writing down thoughts.
	- Process actionable emails and catch-up with news sources like the FT/Economist.
- **11:00 - 17:00** Flexible, but generally a date with wifey on Saturdays, and a weekly shop on Sundays.
- **17:00 - 17:15** Quick double cleanse, oil-based cleanser -> water-based cleanser, rinsing face afterwards, then apply minoxidil into dry scalp again.
- **17:15 - 17:30** Dim lights, and put on some ambient music.
- **17:30 - 18:30** Cook dinner (if it's my day), otherwise relax and journal downstairs.
- **18:30 - 20:00** Eat dinner and wind down.
- **20:00 - 20:30** Clean up from cooking (if it's my day), otherwise just help.
- **20:30 - 20:45** Brush teeth, floss, and tongue scrape. Then, evening skincare (toner -> serum -> moisturiser -> eye cream) followed by some gentle stretching.
- **20:45 - 21:15** Settle down, fall asleep.

# Levels of Organisation

| Tidiness Level |        Room         |         Car         |
| :------------: | :-----------------: | :-----------------: |
|       1        |     Clear trash     |     Clear trash     |
|       2        |    Remove dishes    |     Remove food     |
|       3        |   Handle laundry    |    Wipe mirrors     |
|       4        |      Make bed       |    Wipe windows     |
|       5        |    Clothes away     |    Wipe surfaces    |
|       6        |     Items away      |     Items away      |
|       7        |    Dust surfaces    |    Dust surfaces    |
|       8        |  Change bedsheets   |     Vacuum/mop      |
|       9        |     Vacuum/mop      | Organise containers |
|       10       | Organise containers | Replace essentials  |

| Hygiene Level |        Hair        |     Skin      |        Teeth        |
| :-----------: | :----------------: | :-----------: | :-----------------: |
|       1       |     Brush hair     |  Rinse face   |     Rinse mouth     |
|       2       |      Wet hair      |  Oil cleanse  |    Tongue scrape    |
|       3       |    Shampoo hair    | Water cleanse | Brush teeth (quick) |
|       4       |   Condition hair   |   Exfoliate   | Brush teeth (full)  |
|       5       | Minoxidil hairline |     Toner     |     Floss teeth     |
|       6       | Dermaroll hairline | Essence/serum |  Interdental brush  |
|       7       |    Shaved beard    |   Eye cream   |      Mouthwash      |
|       8       |  Exfoliate scalp   |  Moisturiser  | Tongue scrape again |
|       9       |      Cut hair      |   Sunscreen   |    Whiten teeth     |
|      10       |    Restyle hair    |   Face mask   |    Visit dentist    |

| Orderliness Level |      Personal      |       Academic       |    Professional    |
| :---------------: | :----------------: | :------------------: | :----------------: |
|         1         | Delete spam emails |   Delete old files   | Archive old emails |
|         2         | Archive old emails |     Update tasks     |    Label emails    |
|         3         |    Label emails    |   Plan assignments   |   Quick replies    |
|         4         |   Quick replies    | Complete assignments |     List tasks     |
|         5         |     List tasks     | Complete flashcards  |     Plan tasks     |
|         6         |     Sort files     |  Complete pre-notes  |    Update docs     |
|         7         | Unsubscribe emails |    Complete notes    |  Update tracking   |
