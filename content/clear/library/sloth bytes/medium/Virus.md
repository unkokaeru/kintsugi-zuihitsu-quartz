...
```python runnable
def remove_virus(files_string: str) -> str:
    """
...
if __name__ == "__main__":
    ...
    assert remove_virus("PC Files: antivirus.exe, cat.pdf, lethalmalware.exe, dangerousvirus.exe ") == "PC Files: antivirus.exe, cat.pdf"
    assert remove_virus("PC Files: notvirus.exe, funnycat.gif") == "PC Files: notvirus.exe, funnycat.gif"
    assert remove_virus("PC Files: virus.exe, malware.exe") == "PC Files: Empty"
